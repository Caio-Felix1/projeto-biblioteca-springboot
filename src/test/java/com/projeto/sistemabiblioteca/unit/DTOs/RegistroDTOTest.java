...
public class RegistroDTOTest {
	...
	void deveFuncionarAoInserirNomeDaPessoaValido(String nomeValido) {
		...
		Set<ConstraintViolation<RegistroDTO>> violacoes = validator.validate(registroDTO);
	...
	void deveFuncionarAoInserirDataDeNascimentoValida() {
		...
		Set<ConstraintViolation<RegistroDTO>> violacoes1 = validator.validate(registroDTO1);
		Set<ConstraintViolation<RegistroDTO>> violacoes2 = validator.validate(registroDTO2);
